        ...
        <div style="direction: rtl">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    @can('show-comments')
                        <li class="nav-item has-treeview {{ isActive(['admin.comments.index','admin.comments.unapproved','admin.comments.edit'],'menu-open') }}">
                            <a href="#" class="nav-link {{ isActive(['admin.comments.index','admin.comments.unapproved','admin.comments.edit']) }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('admin.comments.index') }}" class="nav-link {{ isActive(['admin.comments.index','admin.comments.edit']) }}">
                                        <i class="fa fa-circle-o nav-icon"></i>
                                        <p>نظرات تایید شده</p>
                                    </a>
                                </li>
                    ...
                    @can('show-orders')
                        <li class="nav-item has-treeview {{ isActive(['admin.orders.index','admin.orders.payments','admin.orders.show'] , 'menu-open') }}">
                            <a href="#" class="nav-link {{ isActive(['admin.orders.index','admin.orders.payments','admin.orders.show']) }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.discount.index') }}" class="nav-link {{ isActive(['admin.discount.index','admin.discount.create','admin.discount.store']) }}">
