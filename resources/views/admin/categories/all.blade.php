        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools d-flex">
                        ...
                        <div class="btn-group-sm mr-1">
                            @can('create-category')
                                <a href="{{ route('admin.categories.create') }}" class="btn btn-info">ایجاد دسته بندی جدید<i class="fa fa-plus pr-1"></i></a>
                            @endcan
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body table-responsive p-0">
                    @include('admin.layouts.category-groups',['categories' => $categories])
                </div>
                <!-- /.card-body -->
